...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Calculadora Py') # Nomeia a janela da inteface,
        self.setFixedSize(250, 300) # Define um tamanho fixo para janela da interface.
        self.cw = QWidget()
        ...
        self.display.setStyleSheet(
            '* {background: #FFF; color: #000; font-size: 30px;}' # '#FFF': branco | '#000': preto;
        )
        ...
        self.add_btn(
            ...
            'background: #35A7FF; color: #fff; font-weight: 700;'
        )
        ...
        self.add_btn(
            ...
            'background: #6BF178; color: #fff; font-weight: 700;'
        )
        ...
        self.add_btn(QPushButton('j'), 4, 0, 1, 1)
        ...
        self.add_btn(
            QPushButton('='), 4, 4, 1, 1,
            self.eval_igual,
            'background: #FF5964; color: #fff; font-weight: 700;'
        )
    ...
    def eval_igual(self):
        try:
            ...
            self.display.setText('Faltal Erro')
